...
//   setLoading: Dispatch<SetStateAction<boolean>>; // <-- add setter
// }
...
//   loading: false, // default loading true
//   setLoading: () => {},
// });
...
//   const [isLoggedInSecurity, setIsLoggedInSecurity] =
//     useState<boolean>(initialLoginState);
//   const [loading, setLoading] = useState<boolean>(true); // <-- manage loading
